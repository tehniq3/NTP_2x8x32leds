/* original design by niq_ro: https://github.com/tehniq3/ + https://nicuflorica.blogspot.com/2023/05/alt-ceas-ntp-pe-afisaj-din-8x32-leduri.html
...
//  if (WiFi.status() == WL_CONNECTED && millis() - lastUpdatedTime >= updateDelay) 
  if ((millis() - lastUpdatedTime >= updateDelay) || (ora+minut == 0))
  {
