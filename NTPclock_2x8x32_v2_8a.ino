 ...
 * v.2.8a - added time from weather update
*/
...
unsigned long tp0 = 10000;  // delay after start or (re)boot the device to intoregate the weather site or check the clock

unsigned long tpsoare;
unsigned long tpinterogare2 = 60000; // pause to check the status of the sun
...
if (umiditate > 1.)
{
  extrainfo = extrainfo + ", info (";
   extrainfo = extrainfo + orai/10;
    extrainfo = extrainfo + orai%10;
     extrainfo = extrainfo + ":";
      extrainfo = extrainfo + minuti/10;
       extrainfo = extrainfo + minuti%10;
        extrainfo = extrainfo + "):";
